...
if (SERVER) then
    ...
    function ENT:AddProps()
        ...
        note1:SetModel("models/kek1ch/notes_paper_1.mdl")
        ...
        note2:SetModel("models/kek1ch/notes_paper_1.mdl")
        ...
        note3:SetModel("models/kek1ch/notes_paper_1.mdl")
        ...
        note4:SetModel("models/kek1ch/notes_paper_1.mdl")
