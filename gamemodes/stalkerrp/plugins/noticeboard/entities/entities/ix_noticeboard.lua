...
if (SERVER) then
    ...
    function ENT:AddProps()
        ...
        note1:SetModel("models/props_c17/paper01.mdl")
        ...
        note2:SetModel("models/props_c17/paper01.mdl")
        ...
        note3:SetModel("models/props_c17/paper01.mdl")
        ...
        note4:SetModel("models/props_c17/paper01.mdl")
